...
- **43 protocols:** SSH, RDP, MySQL, PostgreSQL, MSSQL, Oracle, Redis, SMB, LDAP, WinRM, SNMP, HTTP Basic Auth, MQTT, and more
...
| Browser | 80/443 | Form | browser-based Microsoft/Entra login |
...
| SOCKS5 | 1080 | SOCKS5 proxy auth | Proxies |
