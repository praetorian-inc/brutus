...
func (p *Plugin) Test(ctx context.Context, target, username, password string,
	...
	if !pluginCfg.NoStickyKeys {
		...
		stickyResult := p.RunStickyKeysCheck(ctx, target, timeout, timeout, pluginCfg.NoVision)
		if stickyResult != nil {
	...
	if !pluginCfg.NoStickyKeys {
		utilmanResult := p.RunUtilmanCheck(ctx, target, timeout, timeout, pluginCfg.NoVision)
