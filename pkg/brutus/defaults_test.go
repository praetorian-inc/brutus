...
func TestDefaultCredentials_LoadsWordlists(t *testing.T) {
	protocols := []string{"ssh", "mysql", "ftp", "redis", "postgresql", "vnc", "rdp", "smb", "mongodb", "snmp", "http", "https", "browser", "elasticsearch", "socks5", "memcached", "kafka", "amqp", "mqtt", "firebird", "xmpp", "rsync"}
